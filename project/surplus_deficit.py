...
def run_resilience_analysis(
    ...
    if supply_csv is None:
        # Use total available energy (production + actual imports for S1).
        # Generated by available_energy_analysis.py — run that first.
        supply_csv = os.path.join(_DATA, "total_available_energy_jan2026.csv")
